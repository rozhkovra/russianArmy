...
import ru.smallmazila.russianarmy.util.SystemUiHider;
...
public class UnitCardActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		double imageKoef = 3/4;
		image.setLayoutParams(new LayoutParams(width*2/3, height*2/3));
		
//		LinearLayout imageLayout = (LinearLayout)findViewById(R.id.imageLayout);
//		imageLayout.setLayoutParams(new LayoutParams(width, height*2/3));

		
		Intent intent = getIntent();
		
		TextView text = (TextView)findViewById(R.id.textView1);
		text.setText(intent.getStringExtra("UnitTitle"));
